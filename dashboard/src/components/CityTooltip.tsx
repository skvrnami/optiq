...
import { CardSectionLabel, CardSectionValue } from './ui/card-section';
        ...
        <div className="flex items-start justify-between gap-2">
          <div className="flex items-start gap-2 min-w-0">
            ...
            <div className="min-w-0">
              <h4 className={`text-sm font-semibold truncate w-full ${colors.text}`}>{city.cityLabel}</h4>
            </div>
          </div>
        </div>
        <Separator />
        <div className="flex flex-col gap-2">
          <CardSectionLabel>Institutes</CardSectionLabel>
          <CardSectionValue>
            <div className="flex flex-col gap-2">
