        ...
        manuscript <- manuscript_joined |>
          mutate(
            ...
            wikidata = if_else(
              ...
              as.character(a(
                wikidata,
                href = paste0("https://www.wikidata.org/wiki/", wikidata),
                target = "_blank"
              )),
              wikidata
            ),
            ...
            permalink = paste0(
              "http://optiq.flu.cas.cz/#!/manuscript_detail?manuscriptId=",
              id
            )
          ) |>
        ...
        div(
          div(
            ...
            div(
              a(
                copies$text[i],
                href = paste0("#!/text_detail?textId=", copies$text_id[i])
              ),
              class = "value"
            ),
            class = "row"
          ...
          div(
            ...
            div(
              a(
                copies$author[i],
                href = paste0("#!/author_detail?authorId=", copies$author_id[i])
              ),
              class = "value"
            ),
            class = "row"
