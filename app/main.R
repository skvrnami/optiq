  ...
  fluidPage(
    sidebarLayout(
      div(
        ...
        tags$ul(
          ...
          tags$li(
            a("Dashboard", href = route_link("dashboard"))
          )
        )
      ),
      ...
      mainPanel(
        router_ui(
          ...
          route(
            "manuscript_detail",
            manuscript_detail$ui(ns("manuscript_detail"))
          ),
    ...
    fluidRow(
      tags$footer(
        ...
        p(
          'The Lindat/CLARIAH-CZ project (LM2023062) is fully supported by the Ministry of Education, Youth, and Sports of the Czech Republic under the programme LM of "Large Infrastructures".'
        )
      )
    )
  )
